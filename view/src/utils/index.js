...
// Receives an object that has key-value pairs from the form and adds to the data
// object following the format of the expense. This is to prepare data to send to the 
