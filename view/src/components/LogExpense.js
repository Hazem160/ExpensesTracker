...
// It displays a circular avatar with the image of the pound when editing or creating
// a new Expense.
import Avatar from '@mui/material/Avatar';
import CurrencyPoundIcon from '@mui/icons-material/CurrencyPound';

import Button from '@mui/material/Button';
// Creates a consistent and elegant baseline for the next elements.
import CssBaseline from '@mui/material/CssBaseline';
import TextField from '@mui/material/TextField';
// Provides a label for form control elements like checkboxes.
import FormControlLabel from '@mui/material/FormControlLabel';
import Checkbox from '@mui/material/Checkbox';
// Equivalent to a "div" in MUI.
import Box from '@mui/material/Box';
import Typography from '@mui/material/Typography';
import Container from '@mui/material/Container';
import { createTheme, ThemeProvider } from '@mui/material/styles';
// Packages that provide label for select inputs and dropdown for the selection
// of the category of the expense.
...
// Front-end API calls;
import {
  createExpense, fetchExpense, formSetter, updateExpense
} from '../utils';
